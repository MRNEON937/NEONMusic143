...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "乛NEON🕊️⃝🦋⁪⁬𝙈𝙐𝙎𝙄𝘾")

OWNER_ID = list(map(int, getenv("OWNER_ID", "5292020082 5292020082").split()))
...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/thesukoonluric")
